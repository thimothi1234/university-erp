...
<div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="index.html">Inward</a>
        <a class="breadcrumb-item" href="index.html">Payment</a>
  ...
  <div class="row">
    <div class="col-sm">
            ...
            <label>Project:</label><br /> 
             ...
             @foreach($ta as $bank_accounts)
                    
                    <option value="{{$bank_accounts->project}}">{{$bank_accounts->projectsss->name}}</option>
                    @endforeach
				    </select>
...
<!-- 
                ...
                <div>
                    ...
                    <select  name="vendor" class="form-control" required="required">
                        ...
                        <option value="{{$bank_accounts->vendor}}">{{$bank_accounts->nmmms->name}}</option>
                        @endforeach
...
<input type="number" name="addmore[0][amount]"  class="txt form-control"  value="{{$bank_accounts->total}}"/>
                    @endforeach
...
<input type="hidden" name="bank" value="{{$bank_accounts->id}}">
</tr>
</table>
