      ...
      @foreach ($post as $value)
        <tr class="post{{$value->id}}">
          ...
          <td>
            ...
            <a href="#" class="edit-modal btn btn-warning btn-sm" data-id="{{$value->id}}" data-title="{{$value->status}}" data-body="{{$value->name}}">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="modal">
          ...
          <div class="form-group">
            ...
            <select name="name" id="t" class="form-control">
              <option value="A Jeevani">A Jeevani</option>
              <option value="V Gowtami">V Gowtami</option>
              ...
              <option value="Vasantha">Vasantha</option>
              <option value="Sadique">Sadique</option>
              <option value="Dasharath">Dasharath</option>
         
            </select>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2"for="body">Name</label>
            <div class="col-sm-10">
...
$('#footer_action_button').text(" Forwrd to Dealing Assitant");
$('#footer_action_button').addClass('glyphicon-check');
$('#footer_action_button').removeClass('glyphicon-trash');
$('.actionBtn').addClass('btn-success');
$('.actionBtn').removeClass('btn-danger');
$('.actionBtn').addClass('edit');
$('.modal-title').text('Inward Assign');
$('.deleteContent').hide();
$('.form-horizontal').show();
