								...
								<div class="col-lg-12">
									...
									<div class="card card-default">
										<div class="card-header card-header-border-bottom">
											<h4 style="text-align:center">Tour & TA Advance</h4>
										</div>
										<div class="card-body">
                                        <form action="{{ route('claim.store') }}" enctype="multipart/form-data" method="POST">
										<div class="container">
                                            @csrf
                                               ...
                                               <div class="col-sm">
												...
												<div class="col-sm">
												<div class="form-group">
													<label for="exampleFormControlInput1">Designatiion<span class="required">*</span></label>
												...
												<div class="col-sm">
												<div class="form-group">
													<label for="exampleFormControlInput1">Paylevel/ Year if student<span class="required">*</span></label>
													<input type="text" class="form-control" id="exampleFormControlInput1" name="paylevel" placeholder="Paylevel/ Year if student" Required>
                                                    @error('paylevel')
                                                    <span class="text-danger">{{ $message}}</span>
                                                    @enderror	
												</div>
												...
												<div class="col-sm">
												<div class="form-group">
													<label for="exampleFormControlInput1">ID No<span class="required">*</span></label>
													<input type="text" class="form-control" id="exampleFormControlInput1" name="idno" placeholder="ID No" Required>
                                                    @error('idno')
                                                    <span class="text-danger">{{ $message}}</span>
                                                    @enderror	
												</div>
                                               ...
                                               <div class="col-sm">
												<div class="form-group">
													<label for="exampleFormControlInput1">Type<span class="required">*</span></label>
												...
												<div class="col-sm">
												<div class="form-group">
													<label for="exampleFormControlInput1">Department.<span class="required">*</span></label>
											...
											<input type="hidden" name="status" value="inward">
												...
												<div class="form-group">
													<label for="exampleFormControlInput1">Purpose of travel/ purchase<span class="required">*</span></label>
													<input type="text" class="form-control" id="exampleFormControlInput1" name="purpose" placeholder="Purpose of travel /purchase" Required>
                                                    @error('purpose')
                                                    <span class="text-danger">{{ $message}}</span>
                                                    @enderror	
												</div></div></div>
                                               ...
                                               <div class="col-sm">
												...
												<div class="form-group">
													<label for="exampleFormControlInput1">Proposed date of journey From<span class="required">*</span></label>
													<input type="date" class="form-control" id="exampleFormControlInput1" name="proposeddate" placeholder="Proposed date of journey" Required>
                                                    @error('proposeddate')
                                                    <span class="text-danger">{{ $message}}</span>
                                                    @enderror	
												</div></div>
												...
												<div class="form-group">
													<label for="exampleFormControlInput1">To<span class="required">*</span></label>
													<input type="date" class="form-control" id="exampleFormControlInput1" name="todate" placeholder="To" Required>
                                                    @error('todate')
                                                    <span class="text-danger">{{ $message}}</span>
                                                    @enderror	
												</div></div>
												...
												<div class="col-sm">
												<div class="form-group">
													<label for="exampleFormControlInput1">Proposed Class of Journey<span class="required">*</span></label >
											...
											<div class="row">
												...
												<label>Pay to:<span class="required">*</span></label> <a href="{{route('vendor.create')}}" target="_blank">Add new Vendor</a><br />  
											...
											<div class="form-group">
												<label for="file">Email Approval Attachment<span class="required">* Max 1mb & Only PDF</span></label>
                    ...
                    @error('file')
											...
											<div class="form-group">
													...
													<div>
															...
															<tr>
															<th scope="col" span="1" style="width: 20%;" >projects<span class="required">*</span></th>
															<th scope="col" span="1" style="width: 20%;">Subhead</th>
															<th scope="col" span="1" style="width: 20%;" >Type<span class="required">*</span></th>
											...
											<td>
											<input name="addmore1[0][onward]" type="text" class="form-control onward" placeholder="onward">	
										</td> 
										<td>
											<input name="addmore1[0][return]" type="text" class="form-control return" placeholder="return" >	
										</td>  
