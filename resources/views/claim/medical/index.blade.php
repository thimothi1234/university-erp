...
<div class="card-header card-header-border-bottom d-flex justify-content-between">
            ...
            <a class="btn btn-success" href="{{ route('medical.create') }}"> New Claim
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                ...
                <th class="wd-15p">ID</th>
                  ...
                  <th class="wd-10p">Referral Attachment</th>
...
@endif
			...
			<td><form action="{{ route('projects.destroy',$payorder->id) }}" method="POST">
                    <a class="btn btn-info" href="{{ route('medical.show',$payorder->id) }}">Show</a>
