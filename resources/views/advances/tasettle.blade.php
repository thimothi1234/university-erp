      ...
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Submit</span>
                      ...
                      <div class="form-group">
												<label for="file">Transaction statment upload if excess amount is drawn</label>
                    ...
                    @error('file')
											...
											<div class="form-group">
													<label for="exampleFormControlInput1">Advance Drawn</label>
													<input type="text" class="form-control" id="exampleFormControlInput1" name="remarks" value="{{$budy->sum('onward')+$budy->sum('return')}}" readonly>
                                                    @error('remarks')
                                                    <span class="text-danger">{{ $message}}</span>
                                                    @enderror	
												</div>
