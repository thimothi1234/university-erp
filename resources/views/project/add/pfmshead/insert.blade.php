								...
								<div class="col-lg-12">
									...
									<div class="card card-default">
										<div class="card-header card-header-border-bottom">
											<h4>PFMS Head Insert</h4>
										</div>
										<div class="card-body">
                                        <form action="{{route('add.pfmshead')}}" method="POST">
                                            @csrf
												<div class="form-group">
													<label for="exampleFormControlInput1">PFMS Head Name</label>
													<input type="text" class="form-control" id="exampleFormControlInput1" name="name" placeholder="PFMS Head Name">
                                                    @error('name')
