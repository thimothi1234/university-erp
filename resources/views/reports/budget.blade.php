...
<div class="card-header card-header-border-bottom d-flex justify-content-between">
											<h4>Budget Head wise Expnditure -- from {{$from }} to {{ $to}}
                      </h4>
...
<tr>
                <th class="wd-15p">Head</th>
                  ...
                  <th class="wd-15p">Sanctioned</th>
                  <th class="wd-15p">Available Fund</th>
    ...
    @foreach($payorders as $payorder)
        <tr class='clickable-row' data-href="{{ url('budgetin', ['id' => $payorder->id, 'from' => $from, 'to' => $to]) }}" >
            ...
            <td> {{$payorder->sanctioned}}</td>
                  <td>{{ 
          (float)($payorder->sanctioned ?? 0) 
          - (float)($payorder->dr_total ?? 0) 
          - (float)($payorder->cr_total ?? 0) 
      }}
      </td>
        </tr>
