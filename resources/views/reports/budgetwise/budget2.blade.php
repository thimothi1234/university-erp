...
<div class="sl-mainpanel">
  ...
  <nav class="breadcrumb sl-breadcrumb">
    ...
    <a class="breadcrumb-item">budget</a>
    <span class="breadcrumb-item active">subhead Summary</span>
  </nav>
      ...
      <table id="example1" class="table table-bordered nowrap" width="100%">
        ...
        <tbody>
          ...
          <tr class='clickable-row'
              data-href="{{ url('budgetwise', ['id' => $payorder->costcentreid,'sid' => $payorder->sid, 'from' => $from, 'to' => $to, 'bank' => $bank]) }}">
