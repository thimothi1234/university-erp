...
<div class="sl-mainpanel">
  ...
  <nav class="breadcrumb sl-breadcrumb">
    ...
    <a class="breadcrumb-item">Budget head</a>
    <span class="breadcrumb-item active">Budget head wise payment Summary</span>
  </nav>
  ...
  <div class="report-card">
    ...
    <div class="report-header d-flex justify-content-between align-items-center">
      <div class="report-title">
        Budget head wise payment Summary
      </div>
      ...
      <table id="example1" class="table table-bordered nowrap" width="100%">
        ...
        <tbody>
          ...
          <tr class='clickable-row'
              data-href="{{ url('budget2', ['id' => $payorder->costcentreid, 'from' => $from, 'to' => $to, 'bank' => $bank]) }}">
