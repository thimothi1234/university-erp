...
<div class="card-header card-header-border-bottom d-flex justify-content-between">
											<h4>Bank Book - @foreach($bud as $bud)  {{$bud->name}}  @endforeach
                     From : 
      ...
      <td style="white-space:normal;">{{$payorder->voucherno_bvrno}}</td>
      ...
      <td style="white-space:normal;">{{$payorder->pfms}}</td>
    
           <td style="white-space:normal;">{{$payorder->entereds->email}}</td>
			...
			<td style="white-space:normal;"><form action="{{ route('Tally.destroy',$payorder->id) }}" method="POST">
                    ...
                    <a class="btn btn-success"  href="http://10.6.160.10/FnA_Digital_Vouchers/{{$payorder->id}}.pdf" target="_blank">Attachment</a>
