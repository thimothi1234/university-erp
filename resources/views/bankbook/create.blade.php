        ...
        <span class="breadcrumb-item active">Insert</span>
								...
								<div class="col-lg-6">
									...
									<div class="card card-default">
										...
										<div class="card-body">
                                        <form action="{{ route('bankbook.index') }}" method="GET">
                                            
											<div class="form-group">
											<label>Bank:</label><br /> 
											<select name="bank" id="" class="form-control myselection" required="required">
                <option value="">--Please select--</option>
				<option value="both">Both 7764 & TSA</option>
                @foreach ($bud as $buds)
...
<div class="form-group">
											<label>Type:</label><br /> 
											<select name="Payment" id="" class="form-control myselection" required="required">
                <option value="">--Please select--</option>
