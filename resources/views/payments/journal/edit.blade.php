    ...
    <div class="col-sm">
                ...
                <option value="{{$ledger->costcentre}}">{{$ledger->costcentres->name}}</option>
                  ...
                  @if($ledger->sub == 0)
                    ...
                    @foreach ($subbu as $subbu )
                    <option value="{{ $subbu->id }}">{{ $subbu->head }}</option>
                    @endforeach
				    </select>
                  </td>
                    <td>
                ...
                <td><select id="bank" class="costcentre form-control js" name="addmoreee[0][costcentre]" required="required">
                <option value="{{$ledgerr->costcentre}}">{{$ledgerr->costcentres->name}}</option>
                ...
                <td>
                                    <select name="addmoreee[0][sub]" class="sub form-control js" id="city0">
                                               @if($ledgerr->sub == 0)
                        <option value="0">Does Not Exists</option>  
                        @else
                    <option value="{{$ledgerr->sub}}">{{$ledgerr->subs->head}}</option>
                    @endif
                    <?php $raj = \App\Models\project_head::all()->where('project_id',$ledgerr->costcentre)->whereNotIn('id',$ledgerr->sub)->all()  ?>
                    @foreach ($raj as $raa)
                    <option value="{{$raa->id}}">{{ $raa->head }}</option>
                        @endforeach
                    </select>
