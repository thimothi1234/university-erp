  ...
  <div class="row">
    ...
    <div class="col-sm">
                ...
                <tr>
                    ...
                    <th scope="col" width="250">Project</th>
                ...
                <div>
                <table class="table-striped" id="dynamicTable12">                <tr>
                <th scope="col"width="350" >Ledger</th>
                    <th scope="col" width="250">Project</th>
                    <th scope="col" width="250">Head</th>
                    <th scope="col" width="90">Dr/Cr</th>
...
<td><select id="state" class="costcentree form-control js" name="addmoreee[0][costcentre]" required="required">
                        <option value="">--select--</option>
...
<td>  <select name="addmoreee[0][sub]" class="sub form-control js" id="city0">
                  <option value="">-- Select Head --</option>
				    </select>
                  </td>
...
<input type="hidden" value="{{ auth()->user()->id }}" name="entered" readonly>
  ...
  <a href="{{route('journal.index')}}" class="btn btn-danger">Cancel X</a>
</form>
</div></div></div>
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document.body).on("change.select2", ".costcentree", function () {
                var id_country = $(this).val();
                var token = $("input[name='_token']").val();
                var el = $(this)
                $.ajax({
