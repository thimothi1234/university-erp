...
<div class="card-header card-header-border-bottom d-flex justify-content-between">
            ...
            <table id="example" class="uk-table uk-table-hover uk-table-striped">
              <thead>
                ...
                <th class="wd-15p">S.No</th>
                  ...
                  <th class="wd-15p">View breakup </th>
      ...
      <td>{{$payorder->inwardsno}}</td>
      <td style="white-space:normal;">  <a class="btn btn-info" target="_blank" href="{{ url('showtds',$payorder->id) }}">Show</a></td>
