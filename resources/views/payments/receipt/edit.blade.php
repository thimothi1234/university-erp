...
<div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="{{route('receipt.index')}}">Voucher</a>
        <a class="breadcrumb-item" href="{{route('receipt.index')}}">Receipts</a>
								...
								<div class="col-lg-12">
									...
									<div class="card card-default">
										<div class="card-header card-header-border-bottom">
											<h4>Receipts Voucher Edit</h4>
										</div>
										<div class="card-body">
                                        <form action="{{route('receipt.update',$user->id)}}" method="POST" enctype="multipart/form-data">
...
<input type="hidden" value='Receipt' name='debit_credit' >
</td>  
...
<input class="sum form-control" type="text" id="sum" name="sum" value="0" readonly /></td>
  ...
  <a href="{{route('receipt.index')}}" class="btn btn-danger">Cancel</a>
</form>
</div></div></div>
