...
<div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="{{route('receipt.index')}}">Receipt</a>
        <a class="breadcrumb-item" href="{{route('receipt.index')}}">Payments</a>
  ...
  <div class="row">
    ...
    <div class="col-sm">
                ...
                <div>
                    ...
                    <input type="hidden" name="chequeno" value="TRF">
...
<input type="hidden" value='{{Carbon\Carbon::now()->format('Y-m-d')}}' name='transactiondate' >
</td>  
...
<input type="hidden" value="{{ auth()->user()->id }}" name="entered" readonly>
  ...
  <a href="{{route('receipt.index')}}" class="btn btn-danger">Cancel X</a>
</form>
</div></div></div>
