...
<!-- 
                ...
                <?php $iio = $commit+1; ?>
                <input type="hidden" name="sub" value="{{$iio}}" readonly/>
                <div class="row">
    <div class="col-sm">
                ...
                <div>
                    ...
                    <br>
                    <input type="text"  name="narration" class="form-control" placeholder="Narration" pattern=".{50,}"   required title="Narrration should be breif atleast 50 characters minimum"/>
