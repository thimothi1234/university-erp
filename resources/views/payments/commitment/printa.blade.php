...
<div class="container">
    ...
    <div class="invoice-box">
       ...
       <h3>&nbsp; Voucher No :<span style="color: red;"></span></h3>
...
R&D<?php $year = ( date('m') > 6) ? date('Y') + 1 : date('Y');?></B></p>
  <p align ="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   NH-9, Kandi- 502285, Phone : 2301 7060</p>
                <h2> CASH / BANK PAYMENT </h2>
                             ...
                             <b> Bank Acount :</b> {{$entries->ledger->bank->name}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
       <td width="40%">{{$ledger->costcentre}}</td>

    <td width="40%">{{$ledger->ledgers->name}}</td>
    <td width="20%" align="right">{{$ledger->amount}}</td>
...
@endforeach
  ...
  <td width="75%" align="right" colspan="2"><b> Net :</b></td>
             ...
             <td width="25%">  <b>  {{$entries->amount}}</b></td></tr>
                    <br>
         ...
         <hr>
               ...
               <p dir="ltr">
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <b> Dated: <span style="color: red;">{{$entries->transactiondate}}</span></b>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <b> UTR NO: <span style="color: red;">{{$entries->transactiondate}}</span></b>
                       </p>
                       <br>
               <p dir="ltr">
                    <b>   Cashier </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
