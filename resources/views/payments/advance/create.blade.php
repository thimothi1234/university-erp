...
<div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="{{route('advance.index')}}">Voucher</a>
        <a class="breadcrumb-item" href="{{route('advance.index')}}">Advance</a>
...
<input type="text"  name="gross" class="form-control" placeholder="Voucher Gross Value" id="change" required />
 ...
 <input type="hidden" name="bank" class="form-control" value="" readonly>
                ...
                <a href="{{route('advance.index')}}" class="btn btn-danger">Cancel X</a>
                </form>
                </div></div></div>
